...
public class MainAppTest {
    ...
    @Test void testRoute3() { assertEquals("Початкова: Вокзал → Кінцева: Парк", TramRouteTab.getRouteInfo(3)); }
    ...
    @Test void testRoute7() { assertEquals("Початкова: Стадіон → Кінцева: Госпіталь", TramRouteTab.getRouteInfo(7)); }
